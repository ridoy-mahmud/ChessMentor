...
try {
  var s = localStorage.getItem('chessmentor:settings:v1');
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ChessMentor — Learn and play chess" },
      {
        name: "description",
        content:
          "Learn chess from beginner to amateur with visual, probability-driven guidance, and play polished games with full sound design.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/chessico.png", type: "image/png" },
